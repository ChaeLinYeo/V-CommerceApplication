...
public class AudioPostProcessEffect {
    ...
    //AutomaticGainControl: 사전 설정된 레벨만큼 output을 자동 조정
    private AutomaticGainControl automaticGainControl = null;
    //NoiseSuppressor : 노이즈 제거
    //stationary(car/airplane engine, AC system) / non-stationary (other peoples conversations, car horn)
