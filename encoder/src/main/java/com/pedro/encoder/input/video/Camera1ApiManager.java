 ...
 *
 *
 * 이 클래스는 VideoEncoder와 동일한 해상도, fps 및 imageFormat을 사용해야합니다.
 * YV12 및 NV21에서 테스트되었습니다.
 * <p>
 * 장점 = 스트림의 fps를 제어 할 수 있습니다.
 * 단점 = 모든 해상도를 사용할 수 없으며 카메라가 지원하는 해상도 만 사용할 수 있습니다.
 * <p>
 * 모든 해상도를 사용하려면 OnPreviewFrame에서 libYuv를 사용하여 이미지 크기를 조정할 수 있습니다.
 * https://chromium.googlesource.com/libyuv/libyuv/
 */
...
public class Camera1ApiManager implements Camera.PreviewCallback, Camera.FaceDetectionListener {
   ...
   * constant values (상수 값의 이름을 알기 위해 위의 주소를 참조)
