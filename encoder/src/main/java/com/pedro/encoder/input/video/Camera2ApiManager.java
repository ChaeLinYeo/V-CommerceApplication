 ...
 *
 * <p>
 * 인코더를 버퍼링하기위한 surfaceEncoder 사용 클래스.
 * 장점 = 모든 해상도를 사용할 수 있습니다.
 * 단점 = 입력 표면을 알 수 없기 때문에 스트림의 fps를 제어 할 수 없습니다
 * 렌더러였습니다.
 * <p>
 * 참고 : surfaceEncoder에 opengl을 사용하여 장치 21 <API> 16의 인코더를 버퍼링 할 수 있습니다.
 * https://github.com/google/grafika
 */
