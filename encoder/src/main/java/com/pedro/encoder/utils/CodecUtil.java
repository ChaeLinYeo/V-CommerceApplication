...
public class CodecUtil {
   ...
   *
   *
   * 이름 및 장치 모델별로 깨진 코덱을 필터링합니다.
   * 노트:
   * 고장난 인코더를 알 수있는 방법이 없으므로 이름과 장치로 확인합니다.
   * 인코더가 감지되면이 방법에 인코더를 추가하십시오.
   * @param codecs 모든 장치 코덱
   * @ 코덱이 깨지지 않은 상태로 목록을 반환
   */
