 ...
 *
 * 이 클래스는 Camera1ApiManagerGl과 동일한 해상도, fps 및 imageFormat을 사용해야합니다.
 */
...
public class VideoEncoder extends BaseEncoder implements GetCameraData {
   ...
   *
   * 인코더가 MediaCodec.INFO_OUTPUT_FORMAT_CHANGED를 호출하지 않는 경우 sps 및 pps 디코딩
   */
   ...
   * buffers.
   *
   * vps, sps 및 pps 버퍼의 시작 인 0 0 0 1 바이트 시퀀스를 찾아야합니다.
   *
